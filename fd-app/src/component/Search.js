...
class Search extends Component{
    ...
    render()  {
       ...
       <div className = "imageContainer">
        ...
        <div class="locationContainer input-group">
        
        <select className = "location" onChange={this.cityHandler}>
                   {this.renderLocation(this.state.location)}                   
                </select>
                <input list="restList" name="rest" id ="rest" class="form-control searchInput" type="text" placeholder=" &#xF002; Search by restaurent" style={{"font-family":"Arial, FontAwesome"}}/>
